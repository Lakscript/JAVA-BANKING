...
-- employees
Insert into bank_schema.employee values(NULL, "Rajesh", "Verma", "Mahesh Verma", "Sunita Sharma", "Manager", "03908967581", "rajesh_verma2311@gmail.com", NULL );
Insert into bank_schema.employee values(NULL, "Daniel", "Thomas", "Thomas Mathew", "Grace Thomas", "Accountant", "03778234199", "daniel.thomas0045@gmail.com", NULL );

-- clients
Insert Into bank_schema.client Values(NULL, "Rohan", "Mehta", "Suresh Mehta", "Priya Sharma", "67153-7853257-8", STR_TO_DATE("17,9,1999", "%d,%m,%Y"), "03787817865", "rohanmehta987@gmail.com", "House No. 412, Street 7, Fasil Colony, Rawalpindi");
Insert Into bank_schema.client Values(NULL, "Anjali", "Kapoor", "Vikram Kapoor", "Neha Kapoor", "78342-0978912-8", STR_TO_DATE("21,3,1995", "%d,%m,%Y"), "03569899631", "anjali_k03@gmail.com", "House No. 112, Street 3B, Block 2, DHA Islamabad");
Insert Into bank_schema.client Values(NULL, "Imran", "Shaikh", "Aslam Shaikh", "Zainab Shaikh", "43210-7809821-1", STR_TO_DATE("7,11,1995", "%d,%m,%Y"), "03665132497", "imranshaikh909@gmail.com", "House No. 8, Street 12, Ramzan Colony, Rawalpindi");
...
-- login account
Insert into bank_schema.login_account values (NULL, "rajesh55", "122221", 'M');
Insert into bank_schema.login_account values (NULL, "danielt211", "909094", 'A');
Insert into bank_schema.login_account values (NULL, "rohan107", "tom891", 'C');
Insert into bank_schema.login_account values (NULL, "anjali_k70", "green8", 'C');
Insert into bank_schema.login_account values (NULL, "imran345", "90jeep", 'C');
